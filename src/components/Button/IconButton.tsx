...
export default function Button({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={onClick}
      className={`relative w-fit flex flex-row items-center justify-between disabled:opacity-70 disabled:cursor-not-allowed rounded-lg hover:opacity-80 transition ${
